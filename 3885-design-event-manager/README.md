<h2><a href="https://leetcode.com/problems/design-event-manager/">3885. Design Event Manager</a></h2><h3>Medium</h3><hr><p>You are given an initial list of events, where each event has a unique <code>eventId</code> and a <code>priority</code>.</p>
